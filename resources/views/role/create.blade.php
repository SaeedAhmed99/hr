            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <p class="card-heading">Create Role</p>
                        {{--  <a href="{{ route('roles.create') }}" class="btn btn-gray"><i class="fa-solid fa-plus"></i></a>  --}}
                    </div>
                </div>
                <div class="card-body">
                    <div class="">
                        <form class="row g-3 needs-validation" novalidate method="post" action="{{ route('roles.store') }}">
                            @csrf
                            <div class="col-md-12">
