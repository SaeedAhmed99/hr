                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                        <div class="d-flex gap-1">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="from" name="from" value="{{ request()->from }}" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="to">to</label>
                                <input class="form-control" type="text" id="to" name="to" value="{{ request()->to }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Filter</button>
                        <a role="button" href="{{ route('employee.timetracker', $employee->user->id) }}" class="btn btn-danger reset_button">Reset</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card p-3">
        <div class="d-flex flex-wrap flex-stack pb-7">
            <div class="d-flex flex-wrap align-items-center my-1">
                <h3 class="fw-bolder me-5 my-1"><span class="text-muted">Time Trackers of:</span> {{ $employee->user->name }}</h3>
            </div>
        </div>
